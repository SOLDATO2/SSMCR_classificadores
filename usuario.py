...
def receber_informacoes_do_classificador():
    ...
    if request.method == 'POST':
        ...
        atributos_predict_forest_class = dados.get('atributos_predict_forest_class')
        atributos_predict_forest_class_PROBA = dados.get('atributos_predict_forest_class_PROBA')
        atributos_predict_forest_cross = dados.get('atributos_predict_forest_cross')
        atributos_predict_forest_cross_PROBA = dados.get('atributos_predict_forest_cross_PROBA')
    ...
    print("Classificação atributos_predict_forest_class: ", atributos_predict_forest_class)
    print("Classificação atributoos_predict_forest_class_PROBA: ", atributos_predict_forest_class_PROBA)
    print("SCORE ALIVE: ", atributos_predict_forest_class_PROBA[0])
    print("SCORE DEAD: ", atributos_predict_forest_cross_PROBA[1])
    print("--------------------------------------------------------------------")
    print("Classificação atributos_predict_forest_cross: ", atributos_predict_forest_cross)
    print("Classificação atributos_predict_forest_cross_PROBA: ", atributos_predict_forest_cross_PROBA)
    print("SCORE ALIVE: ", atributos_predict_forest_cross_PROBA[0])
    print("SCORE DEAD: ", atributos_predict_forest_cross_PROBA[1])
    print("--------------------------------------------------------------------")
